...
/***************************** JTAG ******************************/
#define JTAG_TAP_PORT					GPIOA
#define JTAG_TAP_TCK_PIN				GPIO_PIN_14
#define JTAG_TAP_TDO_PIN				GPIO_PIN_13
...
#define JTAG_TAP_USR_PORT				GPIOB
...
#define JTAG_TAP_TDO_SETINPUT()			GPIO_SetMode(JTAG_TAP_USR_PORT, JTAG_TAP_TDO_PIN, GPIO_MODE_IN_FLOATING)
#define JTAG_TAP_TDO_SET()				GPIO_SetPins(JTAG_TAP_USR_PORT, JTAG_TAP_TDO_PIN)
#define JTAG_TAP_TDO_CLR()				GPIO_ClrPins(JTAG_TAP_USR_PORT, JTAG_TAP_TDO_PIN)
#define JTAG_TAP_TDO_GET()				GPIO_GetInPins(JTAG_TAP_USR_PORT, JTAG_TAP_TDO_PIN)
...
#define JTAG_TAP_TMS_PIN				GPIO_PIN_13
...
#define JTAG_TAP_HS_PortIOInit()		do{\
											...
											GPIO_SetMode(GPIOA, JTAG_TAP_TMS_PIN, GPIO_MODE_AF_PP);\
										}while(0)
...
#define JTAG_TAP_HS_PortIOFini()		do{\
											...
											GPIO_SetMode(GPIOA, JTAG_TAP_TMS_PIN, GPIO_MODE_IN_FLOATING);\
										}while(0)
